...
logging.basicConfig(level=logging.INFO, filename="log/unpooled/fullrank", filemode="a+",
...
for k in valid_k_list:
    ...
    for i in prova_3_subj:
        ...
        with sPPCA:
            approx = pm.fit(100000, method="fullrank_advi",
                            callbacks=[pm.callbacks.CheckParametersConvergence(diff="absolute")])
            trace = approx.sample(500)

        print(type(approx))
        name = 'unpooled/fullrank/k' + str(k) + '_sub' + str(i) + '_'
