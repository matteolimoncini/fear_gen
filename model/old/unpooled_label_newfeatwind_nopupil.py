...
logging.basicConfig(level=logging.INFO, filename="log/unpooled/newfeatwind/nopupil/unpooled_labelADVI1e6",
                    filemode="a+",
...
for k in valid_k_list:
    ...
    for i in prova_3_subj:
        ...
        N_train = int(len(eda) * (1 - TEST_PERC))
        ...
        name = 'unpooled/newfeatwind/nopupil/k' + str(k) + '_sub' + str(i) + '_'
